...
public class PtableController {
    ...
    public Result listNewApplication(@RequestParam(defaultValue = "1") Integer pageNum,
        ...
        LambdaQueryWrapper<PatentNewApplication> wrapper = new LambdaQueryWrapper<PatentNewApplication>()
                .like(patentName != null, PatentNewApplication::getPatentName, patentName)
                .eq(applicationNo != null, PatentNewApplication::getApplicationNo, applicationNo)
                .eq(patentType != null, PatentNewApplication::getPatentType, patentType)
                .like(applicant != null, PatentNewApplication::getApplicant, applicant)
